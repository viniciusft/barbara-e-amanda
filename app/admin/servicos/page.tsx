...
const EMPTY_FORM = { nome: "", descricao: "", duracao_minutos: 60, preco: 0 };
...
export default function ServicosPage() {
  ...
  async function fetchServicos() {
    ...
    // For admin we want all, including inactive — but our public route only returns active
    // We'll use the admin pattern here for simplicity
    ...
    <div className="py-6">
      ...
      <div className="grid gap-3">
        {servicos.map((s) => (
          <div
            key={s.id}
            className={`border p-5 flex flex-col sm:flex-row sm:items-center gap-4 ${
              s.ativo
          ...
          >
            <div className="flex-1">
              ...
              {s.descricao && (
                <p className="text-[rgba(245,240,232,0.4)] text-sm font-sans mb-2">
                  {s.descricao}
                </p>
              )}
