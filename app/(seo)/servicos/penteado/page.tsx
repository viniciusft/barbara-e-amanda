...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${siteUrl}/servicos/penteado`,
  },
  openGraph: {
    title: "Penteado Profissional em Passos MG | Âmbar Beauty Studio",
    description: "Penteados profissionais em Passos MG. Para noivas, formaturas, festas e eventos. Penteado solto, preso, semi-preso e trança. Agende agora.",
    type: "website",
  },
};
...
const DEFAULT_SUBTITULO =
  "Do elegante coque para noiva às ondas soltas para festa — criamos o penteado que combina com você, com o evento e dura a noite toda.";
...
export default async function PenteadoPage() {
  ...
  const waUrl = wanum
    ? `https://wa.me/55${wanum}?text=${encodeURIComponent("Olá! Gostaria de informações sobre penteado.")}`
    : "#";
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Serviços", item: `${siteUrl}/servicos` },
      {
        ...
        position: 3,
        name: "Penteado",
        item: `${siteUrl}/servicos/penteado`,
      },
    ],
  };
  ...
  const imageGallerySchema =
    carrosselFotos.length > 0
      ? {
          "@context": "https://schema.org",
          "@type": "ImageGallery",
          name: "Penteado Profissional — Nosso Trabalho",
          associatedMedia: carrosselFotos.map((f) => ({
            "@type": "ImageObject",
            contentUrl: f.url,
            description: f.titulo ?? "Penteado profissional - Âmbar Beauty Studio - Passos MG",
          })),
        }
      : null;
        ...
        <div className="relative z-10 w-full max-w-5xl mx-auto px-5 py-16 md:py-24">
          ...
          <nav aria-label="Breadcrumb" className="mb-5">
            <ol className="flex items-center gap-2 text-sm text-white/70 flex-wrap">
              ...
              <li className="text-white/40">/</li>
              <li className="text-white/90">Penteado</li>
            </ol>
          </nav>
          ...
          <div className="grid lg:grid-cols-5 gap-12 items-start">
            ...
            <div className="lg:col-span-3 order-2 lg:order-1">
              ...
              <ul className="mt-8 space-y-3">
                {[
                  "Penteados personalizados para cada tipo de cabelo",
                  "Produtos de fixação profissional de longa duração",
                  "Experiência com cabelos lisos, ondulados, cacheados e crespos",
                  "Técnicas atuais: coques, tranças, ondas e semi-presos",
                ].map((item) => (
        ...
        <section className="bg-white py-16">
          <div className="max-w-5xl mx-auto px-5">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              {gridFotos.map((foto) => {
                const alt = foto.titulo ?? "Penteado profissional - Âmbar Beauty Studio - Passos MG";
                return (
                  <div key={foto.id}>
                    <script
                      type="application/ld+json"
      ...
      <section className="bg-neutral-900 py-16">
        <div className="max-w-5xl mx-auto px-5 text-center">
          ...
          <p className="text-white/70 font-sans mb-8 max-w-md mx-auto">
            Agende seu penteado profissional em Passos MG com facilidade
          </p>
          <Link
            href="/agendar"
